...
const Step3Report = ({ report }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-8 py-6">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={downloadPDF}
          className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg shadow-md transition-all duration-300 font-medium text-sm"
        >
          Download PDF
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="space-y-5">
          ...
          >
            ...
            <p className="text-gray-400 mt-2 text-xs">Out of 10</p>
            <div className="mt-3">
              ...
              {questionWiseScore.map((q, i) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-3">
                    ...
                    <div className="bg-green-100 text-green-600 px-2 py-1 rounded-full font-bold text-xs w-fit">
                      {q.score || 0}/10
                    </div>
                  </div>
